...
export function Hero() {
  return (
    ...
    >
      {/* Fundo */}
      <div className="absolute inset-0 bg-gradient-to-br from-zinc-950 via-zinc-900 to-blue-950"></div>

      {/* Luz Azul */}
      <div className="absolute w-[500px] h-[500px] bg-blue-600/20 blur-[180px] rounded-full"></div>
      ...
      >
        ...
        <p className="mt-8 text-zinc-300 text-lg leading-8 max-w-2xl mx-auto">
          ...
          tecnologia. Construindo aplicações Web e Mobile para resolver
          problemas reais.
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-10">
          <a
            ...
            className="bg-blue-600 hover:bg-blue-700 transition px-6 py-3 rounded-xl flex items-center gap-2"
          >
            <FaGithub />
            GitHub
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="border border-blue-500 hover:bg-blue-500 transition px-6 py-3 rounded-xl flex items-center gap-2"
          >
            <FaLinkedin />
            LinkedIn
          </a>
